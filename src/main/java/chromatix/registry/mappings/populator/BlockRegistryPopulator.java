package chromatix.registry.mappings.populator;
...
public final class BlockRegistryPopulator {
    ...
    public static BlockMappings initMapping() {
        try (InputStream stream = BlockRegistryPopulator.class.getClassLoader().getResourceAsStream("mappings/blocks.json")) {
            ...
            Object2ObjectOpenHashMap<JeBlockState, chromatix.block.BlockState> MAP1 = new Object2ObjectOpenHashMap<>();
            Object2ObjectOpenHashMap<chromatix.block.BlockState, JeBlockState> MAP2 = new Object2ObjectOpenHashMap<>();
            blocks.forEach((k, v) -> {
                ...
                chromatix.block.BlockState pnxBlockState = Registries.BLOCKSTATE.get(i);
            ...
            final chromatix.block.BlockState i = BlockFlowingLava.PROPERTIES.getBlockState(CommonBlockProperties.LIQUID_DEPTH.createValue(0));
