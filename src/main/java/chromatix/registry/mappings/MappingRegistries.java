package chromatix.registry.mappings;


import chromatix.registry.mappings.loader.BiomeRegistryLoader;
import chromatix.registry.mappings.loader.LevelSoundEventRegistryLoader;
import chromatix.registry.mappings.populator.BlockRegistryPopulator;
...
public class MappingRegistries {
    ...
    /**
     * A mapped registry which stores the numeric {@link chromatix.network.protocol.types.LevelSoundEvent} id
