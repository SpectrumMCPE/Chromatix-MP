...
import chromatix.item.*;
import chromatix.item.armor.copper.ItemCopperBoots;
import chromatix.item.armor.copper.ItemCopperChestplate;
import chromatix.item.armor.copper.ItemCopperHelmet;
import chromatix.item.armor.copper.ItemCopperHorseArmor;
import chromatix.item.armor.copper.ItemCopperLeggings;
import chromatix.item.customitem.CustomItem;
import chromatix.item.customitem.CustomItemDefinition;
import chromatix.item.tools.copper.ItemCopperAxe;
import chromatix.item.tools.copper.ItemCopperHoe;
import chromatix.item.tools.copper.ItemCopperPickaxe;
import chromatix.item.tools.copper.ItemCopperShovel;
import chromatix.item.tools.copper.ItemCopperSword;
...
public final class ItemRegistry implements ItemID, IRegistry<String, Item, Class<? extends Item>> {
    ...
    public void init() {
        ...
        try {
            ...
            register(DRAGON_HEAD, ItemDragonHead.class);
            ...
            register(PLAYER_HEAD, ItemPlayerHead.class);
            ...
            register(SKELETON_SKULL, ItemSkeletonSkull.class);
            ...
            register(WITHER_SKELETON_SKULL, ItemWitherSkeletonSkull.class);
    ...
    public static chromatix.item.customitem.CustomItemDefinition getCustomItemDefinition(String identifier) {
