 ...
 * chromatix.utils.collection.nb.Long2ObjectNonBlockingMap} with {@link Long} keys is
...
public class Long2ObjectNonBlockingMap<TypeV>
    ...
    // new NBHMLEntry.
    private class NBHMLEntry implements LongObjectEntry<TypeV>, Entry<Long, TypeV> {
     ...
     * iteration.  The {@link chromatix.utils.collection.nb.Long2ObjectNonBlockingMap}
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Long2ObjectNonBlockingMap<TypeV> clone() {
        try {
            // Must clone, to get the class right; NBHML might have been
            // extended so it would be wrong to just make a new NBHML.
            Long2ObjectNonBlockingMap<TypeV> t = (Long2ObjectNonBlockingMap<TypeV>) super.clone();
