 ...
 */
package chromatix.utils.version;
...
/**
 * A comparator that compares two strings as two {@link chromatix.utils.version.Version} objects.
 * @author joserobjr
 * @since 0.1.0
 */
public class VersionStringComparator implements Comparator<String> {
    ...
    /**
     * Compare two strings as two {@link chromatix.utils.version.Version} objects.
