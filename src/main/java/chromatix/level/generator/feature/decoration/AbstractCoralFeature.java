...
import chromatix.block.BlockBrainCoralBlock;
import chromatix.block.BlockBrainCoralFan;
import chromatix.block.BlockBrainCoralWallFan;
import chromatix.block.BlockBubbleCoralBlock;
import chromatix.block.BlockBubbleCoralFan;
import chromatix.block.BlockBubbleCoralWallFan;
import chromatix.block.BlockFireCoralBlock;
import chromatix.block.BlockFireCoralFan;
import chromatix.block.BlockFireCoralWallFan;
import chromatix.block.BlockHornCoralBlock;
import chromatix.block.BlockHornCoralFan;
import chromatix.block.BlockHornCoralWallFan;
import chromatix.block.BlockID;
import chromatix.block.BlockSeaPickle;
import chromatix.block.BlockState;
import chromatix.block.BlockTubeCoralBlock;
import chromatix.block.BlockTubeCoralFan;
import chromatix.block.BlockTubeCoralWallFan;
import chromatix.level.format.IChunk;
import chromatix.math.BlockFace;
import chromatix.utils.random.RandomSourceProvider;

import static chromatix.block.property.CommonBlockProperties.CLUSTER_COUNT;
