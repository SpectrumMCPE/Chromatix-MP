package chromatix.level.generator.noise.d;
...
public class NoiseGeneratorOctavesD {
     ...
     * x,y,z noiseScale)
     */
    public double[] generateNoiseOctaves(int xOffset, int yOffset, int zOffset, int xSize, int ySize, int zSize, double xScale, double yScale, double zScale) {
     ...
     */
    public double[] generateNoiseOctaves(int xOffset, int zOffset, int xSize, int zSize, double xScale, double zScale, double p_76305_10_) {
        return this.generateNoiseOctaves(xOffset, 10, zOffset, xSize, 1, zSize, xScale, 1.0D, zScale);
    }
}
