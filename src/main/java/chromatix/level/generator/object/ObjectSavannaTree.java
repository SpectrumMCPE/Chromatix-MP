...
import chromatix.block.BlockAcaciaLeaves;
import chromatix.block.BlockAcaciaLog;
...
public class ObjectSavannaTree extends TreeGenerator {
     ...
     */
    private final BlockState LEAF = BlockAcaciaLeaves.PROPERTIES.getDefaultState();
