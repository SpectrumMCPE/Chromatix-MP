package chromatix.level.generator.object.structures.jigsaw.trailruins;

import chromatix.block.Block;
import chromatix.block.BlockBrushable;
import chromatix.block.BlockCoarseDirt;
import chromatix.block.BlockDirt;
import chromatix.block.BlockGravel;
import chromatix.block.BlockSuspiciousGravel;
import chromatix.block.BlockUnknown;
import chromatix.blockentity.BlockEntityBrushable;
...
import chromatix.level.generator.object.structures.jigsaw.JigsawStructure;
import chromatix.level.generator.object.structures.jigsaw.pool.StructurePool;
import chromatix.level.generator.object.structures.jigsaw.pool.StructurePoolCollection;
...
import static chromatix.block.BlockAir.STATE;
import static chromatix.block.BlockID.BLUE_STAINED_GLASS_PANE;
import static chromatix.block.BlockID.BROWN_CANDLE;
import static chromatix.block.BlockID.DEADBUSH;
import static chromatix.block.BlockID.FLOWER_POT;
import static chromatix.block.BlockID.GREEN_CANDLE;
import static chromatix.block.BlockID.LIGHT_BLUE_STAINED_GLASS_PANE;
import static chromatix.block.BlockID.MAGENTA_STAINED_GLASS_PANE;
import static chromatix.block.BlockID.OAK_HANGING_SIGN;
import static chromatix.block.BlockID.PINK_STAINED_GLASS_PANE;
import static chromatix.block.BlockID.PURPLE_CANDLE;
import static chromatix.block.BlockID.PURPLE_STAINED_GLASS_PANE;
import static chromatix.block.BlockID.RED_CANDLE;
import static chromatix.block.BlockID.RED_STAINED_GLASS_PANE;
import static chromatix.block.BlockID.SPRUCE_HANGING_SIGN;
import static chromatix.block.BlockID.WHEAT;
...
public class TrailRuinsStructure extends JigsawStructure {
    ...
    private void replaceRandomGravel(BlockManager blockManager, List<Block> gravelBlocks, RandomSourceProvider random, int count, chromatix.block.BlockState replacement, TrailRuinsLoot loot) {
