...
import chromatix.blockentity.BlockEntityChest;
import chromatix.blockentity.BlockEntityMobSpawner;
...
import chromatix.level.generator.object.structures.utils.BoundingBox;
import chromatix.level.generator.object.structures.utils.LiquidUpdater;
import chromatix.level.generator.object.structures.utils.StructurePiece;
...
import static chromatix.block.property.CommonBlockProperties.AGE_4;
import static chromatix.block.property.CommonBlockProperties.MINECRAFT_CARDINAL_DIRECTION;
import static chromatix.block.property.CommonBlockProperties.WEIRDO_DIRECTION;

public class NetherBridgePieces {

    private static final BlockState NETHER_BRICKS = BlockNetherBrick.PROPERTIES.getDefaultState();
    private static final BlockState NETHER_BRICK_FENCE = BlockNetherBrickFence.PROPERTIES.getDefaultState();
    private static final BlockState SOUL_SAND = BlockSoulSand.PROPERTIES.getDefaultState();
    private static final BlockState NETHER_WART = BlockNetherWart.PROPERTIES.getBlockState(AGE_4.createMax());
    ...
    private static final BlockState NETHER_BRICK_STAIRS_S = BlockNetherBrickStairs.PROPERTIES.getBlockState(WEIRDO_DIRECTION.createValue(2));
    ...
    private static NetherBridgePiece findAndCreateBridgePieceFactory(PieceWeight weight, List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
    ...
    abstract static class NetherBridgePiece extends StructurePiece {
        ...
        private NetherBridgePiece generatePiece(StartPiece start, List<PieceWeight> weights, List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
        ...
        private StructurePiece generateAndAddPiece(StartPiece start, List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, @Nullable BlockFace orientation, int genDepth, boolean isCastle) {
        ...
        protected StructurePiece generateChildForward(StartPiece start, List<StructurePiece> pieces, RandomSourceProvider random, int horizontalOffset, int yOffset, boolean isCastle) {
        ...
        protected StructurePiece generateChildLeft(StartPiece start, List<StructurePiece> pieces, RandomSourceProvider random, int yOffset, int horizontalOffset, boolean isCastle) {
            BlockFace orientation = this.getOrientation();
            if (orientation != null) {
                switch (orientation) {
                    case NORTH:
        ...
        protected StructurePiece generateChildRight(StartPiece start, List<StructurePiece> pieces, RandomSourceProvider random, int yOffset, int horizontalOffset, boolean isCastle) {
            BlockFace orientation = this.getOrientation();
            if (orientation != null) {
                switch (orientation) {
                    case NORTH:
    ...
    public static class BridgeStraight extends NetherBridgePiece {
        ...
        public BridgeStraight(int genDepth, RandomSourceProvider random, BoundingBox boundingBox, BlockFace orientation) {
            super(genDepth);
        ...
        public static BridgeStraight createPiece(List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateBox(level, boundingBox, 1, 5, 0, 3, 7, 18, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class BridgeEndFiller extends NetherBridgePiece {
        ...
        public BridgeEndFiller(int genDepth, RandomSourceProvider random, BoundingBox boundingBox, BlockFace orientation) {
            super(genDepth);
            this.setOrientation(orientation);
            this.boundingBox = boundingBox;
        ...
        public static BridgeEndFiller createPiece(List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
        ...
        @Override
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            RandomSourceProvider rand = random.fork();
    ...
    public static class BridgeCrossing extends NetherBridgePiece {
        ...
        protected BridgeCrossing(RandomSourceProvider random, int x, int z) {
            super(0);
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateBox(level, boundingBox, 8, 5, 0, 10, 7, 18, BlockAir.STATE, BlockAir.STATE, false);
            this.generateBox(level, boundingBox, 0, 5, 8, 18, 7, 10, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class RoomCrossing extends NetherBridgePiece {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateBox(level, boundingBox, 0, 2, 0, 6, 7, 6, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class StairsRoom extends NetherBridgePiece {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            this.generateBox(level, boundingBox, 0, 0, 0, 6, 1, 6, NETHER_BRICKS, NETHER_BRICKS, false);
            this.generateBox(level, boundingBox, 0, 2, 0, 6, 10, 6, BlockAir.STATE, BlockAir.STATE, false);
            ...
            this.generateBox(level, boundingBox, 6, 8, 2, 6, 8, 4, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class MonsterThrone extends NetherBridgePiece {
        ...
        @Override
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            this.generateBox(level, boundingBox, 0, 2, 0, 6, 7, 7, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class CastleEntrance extends NetherBridgePiece {
        ...
        public CastleEntrance(int genDepth, RandomSourceProvider random, BoundingBox boundingBox, BlockFace orientation) {
            super(genDepth);
            this.setOrientation(orientation);
            this.boundingBox = boundingBox;
        }
        ...
        public static CastleEntrance createPiece(List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateBox(level, boundingBox, 0, 5, 0, 12, 13, 12, BlockAir.STATE, BlockAir.STATE, false);
            ...
            this.generateBox(level, boundingBox, 6, 1, 6, 6, 4, 6, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class CastleStalkRoom extends NetherBridgePiece {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            BlockState statrsN = BlockNetherBrickStairs.PROPERTIES.getBlockState(WEIRDO_DIRECTION.createMax());
            for (int y = 0; y <= 6; ++y) {
                int z = y + 4;
                ...
                if (y >= 1) {
                    this.generateBox(level, boundingBox, 5, 6 + y, z, 7, 9 + y, z, BlockAir.STATE, BlockAir.STATE, false);
                }
            }
            ...
            this.generateBox(level, boundingBox, 5, 13, 12, 7, 13, 12, BlockAir.STATE, BlockAir.STATE, false);
            ...
            BlockState statrsW = BlockNetherBrickStairs.PROPERTIES.getBlockState(WEIRDO_DIRECTION.createValue(1));
            ...
            BlockState statrsE = BlockNetherBrickStairs.PROPERTIES.getBlockState(WEIRDO_DIRECTION.createValue(0));
    ...
    public static class CastleSmallCorridorPiece extends NetherBridgePiece {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateBox(level, boundingBox, 0, 2, 0, 4, 5, 4, BlockAir.STATE, BlockAir.STATE, false);
    ...
    public static class CastleSmallCorridorRightTurnPiece extends NetherBridgePiece {
        ...
        public CastleSmallCorridorRightTurnPiece(int genDepth, RandomSourceProvider random, BoundingBox boundingBox, BlockFace orientation) {
            super(genDepth);
            this.setOrientation(orientation);
            this.boundingBox = boundingBox;
        ...
        public static CastleSmallCorridorRightTurnPiece createPiece(List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
            BoundingBox boundingBox = BoundingBox.orientBox(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
            return NetherBridgePiece.isOkBox(boundingBox) && StructurePiece.findCollisionPiece(pieces, boundingBox) == null ?
    ...
    public static class CastleSmallCorridorLeftTurnPiece extends NetherBridgePiece {
        ...
        public CastleSmallCorridorLeftTurnPiece(int genDepth, RandomSourceProvider random, BoundingBox boundingBox, BlockFace orientation) {
            super(genDepth);
            this.setOrientation(orientation);
            this.boundingBox = boundingBox;
            this.isNeedingChest = (random.nextBoundedInt(3) == 0);
        ...
        public static CastleSmallCorridorLeftTurnPiece createPiece(List<StructurePiece> pieces, RandomSourceProvider random, int x, int y, int z, BlockFace orientation, int genDepth) {
            BoundingBox boundingBox = BoundingBox.orientBox(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
    ...
    public static class CastleCorridorStairsPiece extends NetherBridgePiece {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            for (int i = 0; i <= 9; ++i) {
                ...
                this.generateBox(level, boundingBox, 1, maxY + 1, i, 3, miny - 1, i, BlockAir.STATE, BlockAir.STATE, false);

                if (i <= 6) {
                    this.placeBlock(level, NETHER_BRICK_STAIRS_S, 1, maxY + 1, i, boundingBox);
                    this.placeBlock(level, NETHER_BRICK_STAIRS_S, 2, maxY + 1, i, boundingBox);
                    this.placeBlock(level, NETHER_BRICK_STAIRS_S, 3, maxY + 1, i, boundingBox);
                }
    ...
    public static class CastleCorridorTBalconyPiece extends NetherBridgePiece {
        ...
        public boolean postProcess(BlockManager level, RandomSourceProvider random, BoundingBox boundingBox, int chunkX, int chunkZ) {
            ...
            this.generateBox(level, boundingBox, 0, 2, 0, 8, 5, 8, BlockAir.STATE, BlockAir.STATE, false);
            ...
            this.generateBox(level, boundingBox, 1, 1, 4, 2, 2, 4, BlockAir.STATE, BlockAir.STATE, false);
            this.generateBox(level, boundingBox, 6, 1, 4, 7, 2, 4, BlockAir.STATE, BlockAir.STATE, false);
    ...
    protected static class ChestPopulator extends RandomizableContainer {
        public ChestPopulator() {
            PoolBuilder pool1 = new PoolBuilder()
                    ...
                    .register(new ItemEntry(Block.OBSIDIAN, 0, 4, 2, 2));
