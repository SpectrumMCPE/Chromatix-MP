package chromatix.level.generator.object.structures.jigsaw.ancientcity;

import chromatix.block.Block;
import chromatix.block.BlockAir;
import chromatix.block.BlockChest;
import chromatix.block.BlockDeepslate;
import chromatix.block.BlockSculkShrieker;
...
import chromatix.level.generator.object.structures.jigsaw.Beardifier;
...
import static chromatix.block.BlockID.CANDLE;
import static chromatix.block.BlockID.PACKED_ICE;
import static chromatix.block.BlockID.SCULK;
import static chromatix.block.BlockID.SCULK_CATALYST;
import static chromatix.block.BlockID.SCULK_SENSOR;
import static chromatix.block.BlockID.SOUL_TORCH;
import static chromatix.block.property.CommonBlockProperties.CAN_SUMMON;
...
public class AncientCityStructure extends JigsawStructure {
    ...
    protected static class AncientCityChestPopulator extends RandomizableContainer {
        ...
        @Override
        public void create(chromatix.inventory.Inventory inventory, RandomSourceProvider random) {
    ...
    private static void populatePool(chromatix.inventory.Inventory inventory, RandomSourceProvider random, List<SpecialItemEntry> entries, int totalWeight, int minRolls, int maxRolls) {
        try {
