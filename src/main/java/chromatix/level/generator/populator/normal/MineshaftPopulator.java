...
import chromatix.level.generator.object.structures.MineshaftPieces;
...
import chromatix.level.generator.object.structures.utils.StructureStart;
...
public class MineshaftPopulator extends Populator implements PopulatorStructure {
    ...
    private static chromatix.block.BlockState seaFloorBlockFor(Level level, Block block) {
