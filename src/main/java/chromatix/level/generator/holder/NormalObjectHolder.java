...
import chromatix.block.BlockStone;
import chromatix.level.Level;
import chromatix.level.format.IChunk;
import chromatix.level.generator.densityfunction.*;
import chromatix.level.generator.material.MaterialFiller;
import chromatix.level.generator.material.Aquifer;
import chromatix.level.generator.material.MultiMaterial;
import chromatix.level.generator.material.OreVeinifier;
...
public class NormalObjectHolder extends RandomizedObjectHolder {
    ...
    public static class SurfaceOverwriteHolder extends RandomizedObjectHolder {
        ...
        private chromatix.block.BlockState[] clayBandsCache;
        ...
        public SurfaceOverwriteHolder(RandomSourceProvider randomSourceProvider) {
            ...
            this.clayBandsCache = new chromatix.block.BlockState[192];
        }
    }
