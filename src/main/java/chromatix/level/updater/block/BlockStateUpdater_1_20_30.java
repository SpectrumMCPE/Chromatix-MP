...
import static chromatix.level.updater.util.OrderedUpdater.DIRECTION_TO_CARDINAL;
import static chromatix.level.updater.util.OrderedUpdater.FACING_TO_BLOCK;
import static chromatix.level.updater.util.OrderedUpdater.FACING_TO_CARDINAL;
