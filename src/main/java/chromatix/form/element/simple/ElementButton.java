package chromatix.form.element.simple;

import chromatix.form.element.Element;
...
/**
 * Represents a button element for use in {@link chromatix.form.window.SimpleForm}.
