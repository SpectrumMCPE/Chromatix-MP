...
import chromatix.item.customitem.data.DigProperty;
import chromatix.item.customitem.data.RenderOffsets;
import chromatix.item.utils.DiggerEntry;
import chromatix.item.utils.ItemArmorType;
import chromatix.item.utils.ItemEnchantSlot;
import chromatix.item.utils.RepairEntry;
import chromatix.item.utils.ShooterAmmo;
