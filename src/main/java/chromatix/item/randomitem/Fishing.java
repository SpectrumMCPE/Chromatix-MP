package chromatix.item.randomitem;

import chromatix.block.BlockID;
import chromatix.item.Item;
import chromatix.item.ItemID;
import chromatix.item.enchantment.Enchantment;
import chromatix.item.randomitem.fishing.FishingEnchantmentItemSelector;
import chromatix.math.NukkitMath;

import static chromatix.item.randomitem.RandomItem.ROOT;
import static chromatix.item.randomitem.RandomItem.putSelector;
import static chromatix.item.randomitem.RandomItem.selectFrom;
