...
import chromatix.block.property.enums.CreakingHeartState;
import chromatix.entity.Entity;
import chromatix.entity.mob.EntityCreaking;
...
public class BlockEntityCreakingHeart extends BlockEntitySpawnable {
    ...
    private boolean hasRequiredLogs() {
        for (BlockFace face : BlockFace.values()) {
            ...
            if (!(block instanceof chromatix.block.BlockPaleOakLog log) || log.getPillarAxis() != getHeart().getPillarAxis()) {
                return false;
            }
        }
        return true;
