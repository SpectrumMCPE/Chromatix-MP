 ...
 * <ul>
 *     <li>{@link chromatix.plugin.annotation.PluginMeta} on the main class emits
 *     {@code plugin.yml} — no handwritten descriptor.</li>
 *     <li>{@link chromatix.plugin.annotation.EventListener} registers listeners
 *     automatically.</li>
 *     <li>{@link chromatix.plugin.annotation.ScheduleTask} schedules tasks
 *     automatically.</li>
 *     <li>{@link chromatix.plugin.annotation.CommandDefinition} registers commands
 ...
 * <pre>
 * dependencies {
 *     compileOnly("chromatix:server:&lt;version&gt;")
 *     annotationProcessor("chromatix:server:&lt;version&gt;")
 * }
 * </pre>
