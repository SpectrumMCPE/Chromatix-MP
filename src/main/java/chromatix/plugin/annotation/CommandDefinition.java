...
/**
 * Marks a {@link chromatix.command.Command} subclass for automatic registration.
 * <p>
 ...
 * instantiates it via the no-argument {@link chromatix.command.Command#Command()}
 * constructor, applies the metadata below (name through
 * {@link chromatix.command.Command#setName(String)}, the rest through the
 ...
 * <ul>
 *     <li>The annotated type must extend {@link chromatix.command.Command}.</li>
