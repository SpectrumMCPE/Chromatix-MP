...
import chromatix.event.plugin.PluginDisableEvent;
import chromatix.event.plugin.PluginEnableEvent;
...
public class JavaPluginLoader implements PluginLoader {
     ...
     * {@code chromatix.plugin.annotation}) and contains the listener
