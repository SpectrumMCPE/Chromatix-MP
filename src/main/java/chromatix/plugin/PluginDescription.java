...
public class PluginDescription {
    ...
    private void loadMap(Map<String, Object> plugin) throws PluginException {
        ...
        if (!this.main.equals("chromatix.plugin.InternalPlugin") && !name.equals("PowerNukkit") && PluginDescription.class.getClassLoader().getResource(this.main.replace('.', '/') + ".class") != null) {
     ...
     * {@code chromatix.plugin.annotation}). When present, the plugin loader
