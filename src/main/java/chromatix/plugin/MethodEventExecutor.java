...
public class MethodEventExecutor implements EventExecutor {
    ...
    public static EventExecutor compile(ClassLoader classLoader, Class<? extends Listener> listenerClass, Method method) {
        ...
        var internalName = "chromatix/plugin/PNXMethodEventExecutor$" + compileTime.incrementAndGet();

        ClassWriter classWriter = new ClassWriter(0);
        FieldVisitor fieldVisitor;
        MethodVisitor methodVisitor;
        classWriter.visit(V17, ACC_PUBLIC | ACC_SUPER, internalName, null, "java/lang/Object", new String[]{"chromatix/plugin/EventExecutor", "chromatix/plugin/CompiledExecutor"});
        ...
        {
            methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "execute", "(Lchromatix/event/Listener;Lchromatix/event/Event;)V", null, new String[]{"chromatix/utils/EventException"});
            methodVisitor.visitCode();
            var label0 = new Label();
            methodVisitor.visitLabel(label0);
            ...
            methodVisitor.visitLabel(label3);
            methodVisitor.visitLocalVariable("this", "L" + internalName + ";", null, label0, label3, 0);
            methodVisitor.visitLocalVariable("listener", "Lchromatix/event/Listener;", null, label0, label3, 1);
            methodVisitor.visitLocalVariable("event", "Lchromatix/event/Event;", null, label0, label3, 2);
    ...
    private static Class<?> loadClass(ClassLoader loader, byte[] b) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, InaccessibleObjectException {
        ...
        try {
            var args =
                    new Object[]{"chromatix.plugin.PNXMethodEventExecutor$" + compileTime.get(), b, 0, b.length};
