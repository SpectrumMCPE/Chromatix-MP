...
import chromatix.permission.ServerOperator;
...
public interface IPlayer extends ServerOperator, Metadatable {
     ...
     * Notice that this will only return its login name. If you need its display name, turn to {@link chromatix.Player#getDisplayName}</p>
     *
     ...
     * @see chromatix.Server#isWhitelisted
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * @see #isWhitelisted
     * @see chromatix.Server#addWhitelist
     * @see chromatix.Server#removeWhitelist
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * @see chromatix.Server#getPlayerExact
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    Player getPlayer();
