...
import chromatix.blockentity.BlockEntityChiseledBookshelf;
import chromatix.event.player.PlayerInteractEvent;
import chromatix.item.Item;
import chromatix.item.ItemBook;
import chromatix.item.ItemBookWritable;
import chromatix.item.ItemEnchantedBook;
...
import static chromatix.block.property.CommonBlockProperties.BOOKS_STORED;
