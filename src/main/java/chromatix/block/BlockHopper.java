...
import chromatix.event.inventory.InventoryMoveItemEvent;
    ...
    public interface IHopper {
        ...
        default boolean pullItems(InventoryHolder hopperHolder, Position hopperPos) {
            ...
            if (blockEntity instanceof InventoryHolder holder) {
                Inventory inv = holder instanceof chromatix.inventory.RecipeInventoryHolder recipeInventoryHolder ? recipeInventoryHolder.getProductView() : holder.getInventory();
