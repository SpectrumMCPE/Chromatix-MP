...
import chromatix.entity.projectile.SlenderProjectile;
...
import chromatix.event.entity.ProjectileHitEvent;
import chromatix.event.player.PlayerFishEvent;
import chromatix.item.Item;
import chromatix.item.enchantment.Enchantment;
import chromatix.item.randomitem.Fishing;
import chromatix.level.MovingObjectPosition;
import chromatix.level.format.IChunk;
import chromatix.level.particle.BubbleParticle;
import chromatix.level.particle.WaterWakeParticle;
