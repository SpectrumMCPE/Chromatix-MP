package chromatix.entity.data.profession;
...
import chromatix.utils.TradeRecipeBuildUtils;
...
public class ProfessionArmor extends Profession {
    ...
    public ListTag<CompoundTag> buildTrades(int seed) {
        ...
        switch (random.nextInt(4)) {
            case 0:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 4), Item.get(Item.IRON_BOOTS, 0, 1))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(1)
                ...
                break;
            case 1:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 7), Item.get(Item.IRON_LEGGINGS, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(1)
                ...
                break;
            case 2:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 5), Item.get(Item.IRON_HELMET, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(1)
                ...
                break;
            case 3:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 9), Item.get(Item.IRON_CHESTPLATE, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(1)
                        .setTraderExp(1)
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.IRON_INGOT, 0, 4), Item.get(Item.EMERALD, 0, 1))
                .setMaxUses(12)
                .setRewardExp((byte) 1)
                .setTier(2)
                .setTraderExp(10)
        ...
        switch (random.nextInt(3)) {
            case 0:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 36), Item.get(BlockID.BELL, 0, 1))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(5)
                ...
                break;
            case 1:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 3), Item.get(Item.CHAINMAIL_LEGGINGS, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(5)
                ...
                break;
            case 2:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 1), Item.get(Item.CHAINMAIL_BOOTS, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(2)
                        .setTraderExp(5)
        ...
        recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.LAVA_BUCKET), Item.get(Item.EMERALD, 0, 1))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(20)
        ...
        switch (random.nextInt(3)) {
            case 0:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 4), Item.get(Item.CHAINMAIL_CHESTPLATE, 0, 1))
                        .setMaxUses(12)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(10)
                ...
                break;
            case 1:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 1), Item.get(Item.CHAINMAIL_HELMET, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(10)
                ...
                break;
            case 2:
                recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 5), Item.get(Item.SHIELD, 0, 1))
                        .setMaxUses(99)
                        .setRewardExp((byte) 1)
                        .setTier(3)
                        .setTraderExp(10)
        ...
        if (random.nextBoolean()) {
            recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 19 + random.nextInt(34 - 19)), diamondLeggings)
                    .setMaxUses(3)
                    .setRewardExp((byte) 1)
                    .setTier(4)
                    .setTraderExp(15)
            ...
            recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 13 + random.nextInt(28 - 13)), diamondBoots)
                    .setMaxUses(99)
                    .setRewardExp((byte) 1)
                    .setTier(4)
                    .setTraderExp(15)
        ...
        if (random.nextBoolean()) {
            recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 21 + random.nextInt(36 - 21)), diamondChestplate)
                    .setMaxUses(3)
                    .setRewardExp((byte) 1)
                    .setTier(5)
                    .setTraderExp(30)
            ...
            recipes.add(TradeRecipeBuildUtils.of(Item.get(Item.EMERALD, 0, 13 + random.nextInt(28 - 13)), diamondHelmet)
                    .setMaxUses(99)
                    .setRewardExp((byte) 1)
                    .setTier(5)
                    .setTraderExp(30)
