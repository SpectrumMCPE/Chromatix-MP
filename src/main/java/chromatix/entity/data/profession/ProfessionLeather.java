...
import chromatix.item.ItemLeatherBoots;
import chromatix.item.ItemLeatherChestplate;
import chromatix.item.ItemLeatherHelmet;
import chromatix.item.ItemLeatherLeggings;
