...
import chromatix.entity.EntityCanSit;
import chromatix.entity.EntityColor;
...
import chromatix.entity.ai.executor.BegExecutor;
...
import chromatix.entity.ai.executor.WolfAttackExecutor;
...
import chromatix.entity.ai.sensor.EntityAttackedByOwnerSensor;
...
import chromatix.inventory.EntityArmorInventory;
import chromatix.inventory.InventoryHolder;
import chromatix.item.Item;
import chromatix.item.ItemDye;
import chromatix.item.ItemID;
import chromatix.item.ItemWolfArmor;
...
public class EntityWolf extends EntityAnimal implements EntityWalkable, EntityCanAttack, EntityCanSit, EntityColor, EntityVariant, InventoryHolder {
    ...
    public static int getBiomeVariant(int biomeId) {
        ...
        String name = Registries.BIOME.getBiomeName(biomeId);
