package chromatix.entity.ai.behaviorgroup;

import chromatix.entity.EntityIntelligent;
import chromatix.entity.ai.behavior.IBehavior;
import chromatix.entity.ai.controller.IController;
import chromatix.entity.ai.memory.IMemoryStorage;
import chromatix.entity.ai.route.finder.IRouteFinder;
import chromatix.entity.ai.sensor.ISensor;
...
public interface IBehaviorGroup {
    ...
    /**
     * Call the evaluator {@link chromatix.entity.ai.evaluator.IBehaviorEvaluator} of all behavior {@link IBehavior} inside the behavior group
     *
    ...
    /**
     * Call the evaluator {@link chromatix.entity.ai.evaluator.IBehaviorEvaluator} of all core behavior {@link IBehavior} inside the behavior group
     *
     * @param entity the target entity object
     */
    ...
    /**
     * Call the executor {@link chromatix.entity.ai.executor.IBehaviorExecutor} of all activated behavior {@link IBehavior} inside the behavior group
     *
     * @param entity the target entity object
     */
    ...
    /**
     * Call the executor {@link chromatix.entity.ai.executor.IBehaviorExecutor} of all activated core behavior {@link IBehavior} inside the behavior group
     *
     * @param entity the target entity object
     */
