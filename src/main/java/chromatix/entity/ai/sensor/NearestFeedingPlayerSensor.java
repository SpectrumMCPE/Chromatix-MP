 ...
 * {@link chromatix.entity.ai.executor.TemptExecutor} (ground) or
 * {@link chromatix.entity.ai.executor.FloatTemptExecutor} (floating), which handle item checks and target selection
