...
public interface IParamNode<T> {
    ...
    /**
     * This method initializes the {@link ParamList} and some parameters obtainable from {@link chromatix.command.data.CommandParameter CommandParameter}, such as optional, enumData, etc. Plugins do not need to call it
     *
