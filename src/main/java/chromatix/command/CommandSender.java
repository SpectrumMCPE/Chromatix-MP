...
public interface CommandSender extends Permissible {
     ...
     * @see chromatix.utils.TextFormat
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
     ...
     * @see chromatix.Player#getName()
     * @see chromatix.command.ConsoleCommandSender#getName()
     * @see chromatix.plugin.PluginDescription
     * @since Nukkit 1.0 | Nukkit API 1.0.0
     */
    @NotNull
    String getName();
     ...
     * <p>
     * The default returns {@link #getName()}. {@link chromatix.Player} overrides this to honor nick
