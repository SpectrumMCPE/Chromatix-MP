package chromatix.command.route;

import chromatix.command.Command;
import chromatix.command.CommandContext;
import chromatix.command.CommandResult;
...
import chromatix.command.route.node.NodeType;
import chromatix.command.route.node.RouteNode;
import chromatix.command.tree.node.*;
...
public class RouteTree {
    ...
    /**
     * Parses a certain number of tokens (defined by {@link chromatix.command.tree.node.IParamNode#getUsedArgs()}) against the node's param node, returning the parsed value or
     ...
     * 
     * @see chromatix.command.tree.node.IParamNode#getUsedArgs()
     */
