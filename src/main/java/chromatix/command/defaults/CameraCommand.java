...
import chromatix.command.tree.node.FloatNode;
import chromatix.command.tree.node.PlayersNode;
import chromatix.command.tree.node.RelativeFloatNode;
...
public class CameraCommand extends VanillaCommand {
    ...
    private NamedDefinition findPreset(String name) {
        return DefaultCameraPresets.getDefinition(name);
    }
