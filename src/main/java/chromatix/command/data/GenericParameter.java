...
import chromatix.command.tree.node.ChainedCommandNode;
import chromatix.command.tree.node.ItemNode;
 ...
 * @see chromatix.command.tree.node.ItemNode
 * @see chromatix.command.tree.node.ChainedCommandNode
 */
public interface GenericParameter {
     ...
     * Produces a parameter named "itemName" using {@link CommandEnum#ENUM_ITEM} and {@link chromatix.command.tree.node.ItemNode} for advanced parsing.
     */
     ...
     * Produces a parameter named "chainedCommand" using {@link CommandEnum#CHAINED_COMMAND_ENUM} and {@link chromatix.command.tree.node.ChainedCommandNode}.
     * <p>
