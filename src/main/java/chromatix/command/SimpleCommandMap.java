...
import chromatix.command.defaults.*;
import chromatix.command.simple.Arguments;
import chromatix.command.simple.CommandParameters;
import chromatix.command.simple.CommandPermission;
import chromatix.command.simple.ForbidConsole;
import chromatix.command.simple.Parameters;
import chromatix.command.simple.SimpleCommand;
...
public class SimpleCommandMap implements CommandMap {
    ...
    public void registerSimpleCommands(Object object) {
        for (Method method : object.getClass().getDeclaredMethods()) {
            chromatix.command.simple.Command def = method.getAnnotation(chromatix.command.simple.Command.class);
            if (def != null) {
