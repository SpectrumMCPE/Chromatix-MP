...
import chromatix.blockentity.ICommandBlock;
...
import chromatix.lang.PluginI18nManager;
...
public record CommandLogger(Command command,
    ...
    /**
     * Add a message, the parameters can be plain text, or client-side, server-side, and multilingual text in {@link chromatix.lang.PluginI18n PluginI18n}, default output color red
     *
     * @param key the key
     * @return the command logger
     */
