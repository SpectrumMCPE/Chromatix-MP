...
public class CommandDefaultsSmokeTest {
    ...
    void defaultCommandsBuildAndExposeMetadata() {
        ...
        chromatix.config.ServerSettings settings = Mockito.mock(chromatix.config.ServerSettings.class);
        chromatix.config.category.DebugSettings debug = Mockito.mock(chromatix.config.category.DebugSettings.class);
