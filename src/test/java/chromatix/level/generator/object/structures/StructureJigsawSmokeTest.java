...
import chromatix.level.generator.object.structures.jigsaw.bastion.BastionStructure;
...
import chromatix.level.generator.object.structures.jigsaw.village.DesertVillageStructure;
import chromatix.level.generator.object.structures.jigsaw.village.PlainsVillageStructure;
import chromatix.level.generator.object.structures.jigsaw.village.SavannaVillageStructure;
import chromatix.level.generator.object.structures.jigsaw.village.SnowyVillageStructure;
import chromatix.level.generator.object.structures.jigsaw.village.TaigaVillageStructure;
...
public class StructureJigsawSmokeTest {
    ...
    void structureHelperOps() {
        ...
        safe(() -> helper.fill(new BlockVector3(0, 0, 0), new BlockVector3(2, 2, 2),
                chromatix.block.BlockCobblestone.PROPERTIES.getDefaultState()));
        safe(() -> helper.fill(new BlockVector3(0, 0, 0), new BlockVector3(3, 3, 3),
                chromatix.block.BlockCobblestone.PROPERTIES.getDefaultState(),
                chromatix.block.BlockDirt.PROPERTIES.getDefaultState()));

        java.util.Map<chromatix.block.BlockState, Integer> weights = new java.util.HashMap<>();
        helper.addRandomBlock(weights, 3, chromatix.block.BlockDirt.PROPERTIES.getDefaultState());
        helper.addRandomBlock(weights, 1, chromatix.block.BlockCobblestone.PROPERTIES.getDefaultState());
