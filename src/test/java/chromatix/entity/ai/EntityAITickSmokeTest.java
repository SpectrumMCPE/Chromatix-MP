...
public class EntityAITickSmokeTest {
    ...
    private static chromatix.block.BlockState firstSolidState() {
        for (chromatix.block.BlockState s : Registries.BLOCKSTATE.getAllState()) {
